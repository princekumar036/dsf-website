...
<main class="min-h-screen p-10 md:p-0 md:py-10">
    ...
    <p class="mb-4">DSF identifies the <b>socio-economic and environmental challenges as structural and inter-linked to global capitalism</b>, which places profit over people. Therefore, we believe that only a peoples' solidarity can build a better world that egalitarian and ensures social justice. We believe that only an alternative economic system that place <b>PEOPLE & ENVIRONMENT OVER PROFIT</b> can be the answer.</p>
    </div>
</main>
